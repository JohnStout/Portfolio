...
# create a dataframe containing data of interest into something manageable
TimeInt_df = nwb.processing['behavior'].data_interfaces['states'].to_dataframe()

# lets extract electrophysiological data
lfpData = nwb.processing['ecephys'].data_interfaces['LFP'].electrical_series['lfp'].data[:]
